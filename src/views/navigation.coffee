define (require) ->
    ...
    EventDetailsView                       = require 'app/views/event-details'
    ServiceTreeView                        = require 'app/views/service-tree'
    PositionDetailsView                    = require 'app/views/position-details'
    UnitDetailsView                        = require 'app/views/unit-details'
    SearchInputView                        = require 'app/views/search-input'
    SidebarRegion                          = require 'app/views/sidebar-region'
    MapView                                = require 'app/map-view'
    {SidebarLoadingIndicatorView}          = require 'app/views/loading-indicator'
    {SearchLayoutView, UnitListLayoutView} = require 'app/views/search-results'
    {InformationalMessageView}             = require 'app/views/message'
    {SearchResultsSummaryLayout, UnitListingView} = require 'app/views/new-search-results.coffee'
