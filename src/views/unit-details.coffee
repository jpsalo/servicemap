define (require) ->
    ...
    ResourceReservationListView= require 'app/views/resource-reservation'
    {AccessibilityDetailsView} = require 'app/views/accessibility'
    {getIeVersion}             = require 'app/base'
    {generateDepartmentDescription} = require 'app/util/organization_hierarchy'
