define (require) ->
    ...
    MapBaseView               = require 'app/map-base-view'
    TransitMapMixin           = require 'app/transit-map'
    map                       = require 'app/map'
    MapStateModel             = require 'app/map-state-model'
    ToolMenu                  = require 'app/views/tool-menu'
    LocationRefreshButtonView = require 'app/views/location-refresh-button'
    SMPrinter                 = require 'app/map-printer'
    MeasureTool               = require 'app/measure-tool'
