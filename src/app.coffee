define (require) ->
    ...
    AppState                 = require 'app/app-state'
    p13n                     = require 'app/p13n'
    MapView                  = require 'app/map-view'
    landingPage              = require 'app/landing'
    ColorMatcher             = require 'app/color'
    tour                     = require 'app/tour'
    debug                    = require 'app/debug'
    ServiceCartView          = require 'app/views/service-cart'
    NavigationLayout         = require 'app/views/navigation'
    PersonalisationView      = require 'app/views/personalisation'
    LanguageSelectorView     = require 'app/views/language-selector'
    titleViews               = require 'app/views/title'
    FeedbackFormView         = require 'app/views/feedback-form'
    FeedbackConfirmationView = require 'app/views/feedback-confirmation'
    TourStartButton          = require 'app/views/feature-tour-start'
    disclaimers              = require 'app/views/service-map-disclaimers'
    ExportingView            = require 'app/views/export'
    sm                       = require 'app/base'
    widgets                  = require 'app/widgets'
    BaseControl              = require 'app/control'
    BaseRouter               = require 'app/router'
    exportUtils              = require 'app/util/export'
    Analytics                = require 'app/analytics'
    CancelToken              = require 'app/cancel-token'
    {isFrontPage}            = require 'app/util/navigation'
